...
public class AddPropertyActivity extends AppCompatActivity {
    EditText name, bed, bath, amenities, description, price, brosur;
    ...
    String spinnertype[],  Gendertype[],message;
    ...
    Spinner city, category, type,area;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> GenderSpinner = new ArrayAdapter<>(AddPropertyActivity.this, R.layout.spinner, this.Gendertype);
        GenderSpinner.setDropDownViewResource(R.layout.spinner);
        area.setAdapter(GenderSpinner);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String getarea = String.valueOf(type.getSelectedItem());
    ...
    public void uploadData() {
        ...
        request.setMethod("GET")
                ...
                .addParameter("area", String.valueOf(type.getSelectedItem()))
