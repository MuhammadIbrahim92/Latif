...
public class FullImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fullpath = new File(Environment.getExternalStorageDirectory() +"/otacodes/"+chat_id+".jpg");
        ...
        direct = new File(Environment.getExternalStorageDirectory() +"/otacodes/");
    ...
    public void Savepicture(final boolean isfromshare){
        if(Checkstoragepermision()) {
            ...
            final File direct = new File(Environment.getExternalStorageDirectory() + "/DCIM/otacodes/");
            progressDialog.show();
